package com.github.losemy.simple.dal.auto.generate;
...
//                .setTablePrefix("sys_")// 去除前缀
                ...
                //自定义实体父类
                .setSuperEntityClass("com.github.losemy.dal.model.BaseDO")
                // 自定义实体，公共字段
...
//                .setSuperServiceClass("org.crown.framework.service.BaseService")
    ...
    protected DataSourceConfig getDataSourceConfig() {
        return new DataSourceConfig()
                ...
                .setUsername("lose")
                .setPassword("lose")
                .setUrl("jdbc:mysql://192.168.0.110:3306/simple?characterEncoding=utf8");
    }
